...
function fillDatabase(){
	...
	*/
	function populateQuest1(questID){
		...
		SimpleText.database.addPicture(questID, nisseContId, "assets/web/printScreen04.png");
		SimpleText.database.addSound(questID, nisseContId, "assets/audio/audio_quest1_01.mp3");
		...
		SimpleText.database.addPicture(questID, oleContId, "assets/web/printScreen01.png");
	...
	*/
	function populateQuest2(questID){
		...
		oleContId = SimpleText.database.addContribution(questID,
														"óle",
														"You can't figure this out you little idiot?!");
		...
		var fComTexts = ["You ignored a lot of information.",
						...
						"Try jumping.",
						"That wasn't everything he said. You "+
						"forgot some of the story relevant parts."];
		for (var j=0; j < 4; ++j){
			SimpleText.database.addVote(questID, fredContId);
			SimpleText.database.addComment(questID, fredContId, fComNames[j], fComTexts[j]);
		}
